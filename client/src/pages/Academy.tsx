...
export default function Academy({ onTabChange }: AcademyProps) {
 ...
 ><AnimatedCounter value={stats.totalExercises} /></div><div style={{ fontSize: 12, color: "var(--muted-foreground)" }}>
 Exercícios
 </div></div></div>
 ...
 ><Trash2 size={14} color="#EF4444" /></button></div><div
 ...
 {exercise.repMax}
 </div></div><div style={{ display: "flex", gap: 4 }}><button
 onClick={e => {
 e.stopPropagation();
 ...
 ><Edit2 size={14} color="var(--muted-foreground)" /></button><button
 onClick={e => {
 e.stopPropagation();
 ...
 ><Trash2 size={14} color="#EF4444" /></button></div></button>
 ...
 >
 Séries
 </div><div style={{ color: "#06B6D4", fontWeight: 600 }}>
 ...
 <div className="animate-in fade-in duration-500"><div className="notebook-sheet notebook-sheet--margined" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}><h2 style={{ fontSize: 18, fontWeight: 600, color: "var(--foreground)", fontFamily: "Space Grotesk" }}>
 ...
 Exercícios padrão
 </h3><span style={{ color: "var(--muted-foreground)", fontSize: 12 }}>
 ...
 </div></section><section style={{ marginTop: 28 }}><div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 12 }}><h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: "var(--foreground)" }}>
 Meus exercícios
 </h3><span style={{ color: "var(--muted-foreground)", fontSize: 12 }}>
 ...
 ><Trash2 size={16} color="#EF4444" /></button></div>
 ))}
 </div>
 )}
 </section></div>
 ...
 <div className="animate-in fade-in duration-500"><Evolution 
