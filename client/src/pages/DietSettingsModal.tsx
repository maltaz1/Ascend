...
export function DietSettingsModal({
 ...
 ><div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}><span style={{ fontSize: 20 }}> </span><label style={{ fontFamily: 'Space Grotesk', fontSize: 13, fontWeight: 600, color: '#F59E0B', margin: 0 }}>
 ...
 <div><div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}><span style={{ fontSize: 20 }}> </span><label style={{ fontFamily: 'Space Grotesk', fontSize: 13, fontWeight: 600, color: '#10B981', margin: 0 }}>
 Macronutrientes
 </label></div><div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 12 }}>
 {/* Protein */}
 <div
 style={{
 ...
 ><div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}><span style={{ fontSize: 20 }}>💧</span><label style={{ fontFamily: 'Space Grotesk', fontSize: 13, fontWeight: 600, color: '#38BDF8', margin: 0 }}>
 Meta de Hidratação
 </label></div><input
 className="fz-input"
 type="number"
