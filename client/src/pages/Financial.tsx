...
export default function Financial() {
 ...
 <div key={label} style={{ ...cardBase, padding: "16px" }}><div
 style={{
 fontSize: "10px",
 fontWeight: 600,
 letterSpacing: "0.1em",
 ...
 >
 {label}
 </div><div style={badgeStyle(change)}>
 {change < 0 ? "↓" : change > 0 ? "↑" : "—"}{" "}
 {change !== 0
 ...
 ><ChevronLeft size={16} /></button><span
 style={{
 fontSize: "12px",
 fontWeight: 600,
 ...
 ><div><div className="ledger-marginalia" style={{ marginBottom: 8 }}>
 08 — Distribuição
 </div><span
 style={{
 fontSize: "13px",
 ...
 {chartType === "pie" && (
 <div><ResponsiveContainer width="100%" height={220}><PieChart><Pie
 data={chartData}
 cx="50%"
 cy="50%"
 innerRadius={60}
