...
export default function Dashboard() {
 ...
 ><div className="ledger-marginalia" style={{ marginBottom: 12 }}>
 01 — Painel de nível
 </div><div
 style={{
 display: "flex",
 ...
 Tarefas do mês
 </div><div style={{ fontSize: 14, fontWeight: 600, marginTop: 4 }}>
 ...
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-5"><div><div style={{ fontSize: 13, fontWeight: 600, marginBottom: 10 }}>
 Evolução do Saldo
 </div><ResponsiveContainer width="100%" height={200}><AreaChart data={balanceEvolution}><CartesianGrid strokeDasharray="3 3" stroke="var(--border)" /><XAxis
 dataKey="date"
 tick={{ fontSize: 11, fill: "var(--muted-foreground)" }}
 /><YAxis tick={{ fontSize: 11, fill: "var(--muted-foreground)" }} /><Tooltip content={<CustomTooltip />} /><Area
 type="monotone"
 dataKey="balance"
 name="Saldo"
 stroke="#10B981"
 ...
 <div><div style={{ fontSize: 13, fontWeight: 600, marginBottom: 10 }}>
 Gastos por Categoria
 </div><ResponsiveContainer width="100%" height={200}><PieChart><Pie
 ...
 </Pie><Tooltip /></PieChart></ResponsiveContainer><div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 8, justifyContent: "center" }}>
 {expensesByCategory.map((entry: any, index: number) => (
 <div
 key={index}
 style={{
