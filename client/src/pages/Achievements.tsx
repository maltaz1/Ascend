...
export default function Achievements() {
 ...
 {/* Header */}
 <div style={{ marginBottom: 28 }}><h1 style={{ fontFamily: 'Space Grotesk', fontWeight: 800, fontSize: 28, color: 'var(--foreground)', marginBottom: 4 }}>
 Conquistas
 ...
 </div><div className="level-badge" style={{
 position: 'absolute',
 bottom: -4,
 right: -4,
 fontSize: 12,
 ...
 {/* Stats */}
 <div style={{ flex: 1 }}><h2 style={{ fontFamily: 'Space Grotesk', fontWeight: 800, fontSize: 22, color: 'var(--foreground)', marginBottom: 4 }}>
 {data.user.name}
 ...
 </div><div style={{ fontFamily: 'DM Sans', fontSize: 11, color: 'var(--muted-foreground)' }}>{stat.label}</div></div>
 ))}
 ...
 {/* Trophy image */}
 <div style={{ flexShrink: 0 }}><img src={ACHIEVEMENT_BADGE_URL} alt="Trophy" style={{ width: 80, height: 80, objectFit: 'contain', filter: unlocked.length > 0 ? 'none' : 'grayscale(1) opacity(0.3)' }} /></div></div>
 ...
 {achievement.emoji}
 </div><div style={{ flex: 1, minWidth: 0 }}><div style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 14, color: 'var(--foreground)', marginBottom: 2 }}>
 {achievement.title}
 </div><div style={{ fontFamily: 'DM Sans', fontSize: 12, color: 'var(--muted-foreground)' }}>
 ...
 {/* Locked Achievements */}
 {locked.length > 0 && (
 <div><div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}><Lock size={16} color="var(--muted-foreground)" /><h2 style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 17, color: 'var(--muted-foreground)' }}>
 Bloqueadas
 </h2><span className="fz-badge" style={{ background: 'var(--border)', color: 'var(--muted-foreground)', border: '1px solid var(--border)' }}>
 {locked.length}
 </span></div><div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 12 }}>
 {locked.map(achievement => (
 <div key={achievement.id} className="achievement-card locked"><div style={{
 width: 44,
 height: 44,
 borderRadius: 6,
 ...
 {achievement.emoji}
 </div><div style={{ flex: 1, minWidth: 0 }}><div style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 14, color: 'var(--muted-foreground)', marginBottom: 2 }}>
 {achievement.title}
 </div><div style={{ fontFamily: 'DM Sans', fontSize: 12, color: 'var(--muted-foreground)' }}>
 {achievement.description}
 </div></div><Lock size={14} color="var(--muted-foreground)" style={{ flexShrink: 0 }} /></div>
 ))}
 </div></div>
 )}
 ...
 <div style={{ textAlign: 'center', padding: '60px 20px' }}><div style={{ fontSize: 48, marginBottom: 16 }}> </div><h3 style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 20, color: 'var(--muted-foreground)' }}>
