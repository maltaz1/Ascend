...
function NutritionCircle({
 ...
 ><div style={{ position: "relative", width: 120, height: 120 }}><svg width="120" height="120" style={{ transform: "rotate(-90deg)" }}><circle
 cx="60"
 cy="60"
 r={radius}
 fill="none"
...
function AddFoodModal({
 ...
 {food.description}
 </div><div style={{ fontSize: 11, color: "rgba(168,85,247,0.6)" }}>
...
function WaterModal({
 ...
 return (
 <Modal open={open} onClose={onClose} title=" Registrar Hidratação"><div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
 {/* Progress Bar */}
 <div
 style={{
 background: "#13171d",
...
export default function Diet() {
 ...
 {/* Nutrition Summary */}
 <div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><NutritionCircle
 ...
 </div></div></div><div style={{ display: "flex", gap: 8 }}><button
 ...
 type => (
 <div key={type} style={{ marginBottom: 24 }}><div
 style={{
 display: "flex",
 justifyContent: "space-between",
 alignItems: "center",
